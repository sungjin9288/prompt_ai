...
const promptStudioSourceRegistry = {
  ...
  "library-operational-summary": {
    ...
    sourceActionLabel: "Library 운영 요약으로 돌아가기",
  ...
  "library-source-health-filter": {
    ...
    sourceActionLabel: "Library 필터로 돌아가기",
  ...
  "library-studio-operational-group": {
    ...
    sourceActionLabel: "Library 운영 묶음으로 돌아가기",
  ...
  "library-missing-source-metadata-queue": {
    ...
    sourceActionLabel: "Library 큐로 돌아가기",
  ...
  "library-no-source-meta": {
    ...
    sourceActionLabel: "원본 저장본으로 돌아가기",
  ...
  "library-learning-context": {
    ...
    sourceActionLabel: "Library 학습 증거로 돌아가기",
  ...
  "learning-readiness": {
    ...
    sourceActionLabel: "Learning 준비도로 돌아가기",
  ...
  "learning-filter": {
    ...
    sourceActionLabel: "Learning 조건으로 돌아가기",
  ...
  "learning-feedback-improvement": {
    ...
    sourceActionLabel: "Learning 피드백 큐로 돌아가기",
  ...
  "learning-memory": {
    ...
    sourceActionLabel: "Learning 메모리로 돌아가기",
